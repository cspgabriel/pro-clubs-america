...
export default function PrivacyPage() {
  return <main className="app-shell legal-page">
    ...
    <article className="legal-content">
      ...
      <section><h2>4. Exclusão de conta e dados</h2><p>Para solicitar a exclusão da conta e dos dados associados, envie uma solicitação para <a href="mailto:gabriel@proclubsamerica.com">gabriel@proclubsamerica.com</a> usando o e-mail cadastrado. Confirmaremos a solicitação e removeremos os dados que não precisem ser mantidos por obrigação legal ou prevenção a fraude.</p></section>
      <section><h2>5. Compartilhamento e visibilidade</h2><p>Nome de exibição, clube vinculado, função, país, dados esportivos publicados, fotos da vitrine, links de vídeo, anúncios e desafios podem ser exibidos a outros usuários. E-mail e identificadores internos não são expostos no diretório público.</p></section>
