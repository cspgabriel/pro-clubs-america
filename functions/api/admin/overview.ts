...
interface ClubRow { id: string; name: string; ea_club_id: string; platform: string; country_slug: string | null; created_at: string }
...
export const onRequestGet = async (context: FunctionContext) => {
  try {
    ...
    const [
      ...
      supabaseRest<ClubRow[]>(context.env, "clubs?select=id,name,ea_club_id,platform,country_slug,created_at&order=created_at.desc&limit=25"),
